    ...
    <Panel header={$provenanceModel.provTitle}>
      ...
      {:else}
        <div class="text-gray-700 text-sm">
          ...
          <p class="pt-3 leading-5">You can also combine values with AND and OR </p><span class="example">uuid: (("^6" AND "5$") OR "ee")</span><p class="leading-5">Will match all uuids that start with 6 and end with 5 or contain "ee"</p>
        </div>
      {/if}
    </Panel>
  </div>
