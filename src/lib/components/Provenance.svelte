    ...
    <Panel header={$provenanceModel.provTitle}>
      ...
      {:else}
        <div class="text-gray-700">
          ...
          <p class="leading-5">If the value you are searching for is a string it must be in quotes in your search query </p><span class="example">type: "FeatureData"</span>
          <p class="pt-3 leading-5">String values match on includes and all other values match on equality </p><span class="example">type: "FeatureData"</span><p class="leading-5">will match all types containing "FeatureData"</p><span class="example">sampling_depth: 1000</span><p class="leading-5">will only match sampling depths equaling exactly 1000</p>
